var articleApp = angular.module('articleApp', ['angles']);
...
articleApp.controller('ArticleController', function ($scope, $log, $sce, ArticleService) {
    ...
    $scope.refreshData = function (articleId, beginDate, endDate) {
    ...
    $scope.getAuthor = function (articleId) {
        ...
        ArticleService
            ...
            .then(function (author) {
                $scope.Author = author;
                $scope.TotalCount = author.TotalCount;
                $scope.myChartData.labels = author.Labels;
                $scope.myChartData.datasets = [{
    ...
    var params = (location.pathname.match(/\/article\/(.*)/)[1]).split("/");
    console.log(params);

    $scope.refreshData(params[0], params[1], params[2]);
